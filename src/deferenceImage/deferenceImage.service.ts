...
export class DeferenceImageService {
    ...
    async createDeferenceImage(createDeferenceImageInput: CreateDeferenceImageInput): Promise<DeferenceImage> {
    ...
    async updateDeferenceImage(updateDeferenceImageInput: UpdateDeferenceImageInput): Promise<DeferenceImage> {
