...
export class DeferenceImageResolver {
  ...
  createDeferenceImage(
    @Args('createDeferenceInput')
    createDeferenceImageInput: CreateDeferenceImageInput,
  ) {
    return this.deferenceImageService.createDeferenceImage(
      createDeferenceImageInput,
    );
  }

  @Mutation((returns) => DeferenceImageResponse)
  updateDeferenceImage(
    @Args('updateDeferenceInput')
    updateDeferenceImageInput: UpdateDeferenceImageInput,
  ) {
    return this.deferenceImageService.updateDeferenceImage(
      updateDeferenceImageInput,
    );
  }
